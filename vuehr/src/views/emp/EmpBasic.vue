<template>
  <div>
          ...
          <el-row style="margin-top: 10px">
            <el-col :span="5">
              ...
              <el-popover
                ...
                <div slot="reference"
                     style="width: 130px;margin-left:3px;display: inline-flex;font-size: 13px;border:1px solid #dedede;height: 26px;border-radius: 5px;cursor: pointer;align-items: center;padding-left: 8px;box-sizing: border-box"
                     @click="showDepView">
                  {{ inputDepName }}
                </div>
              </el-popover>
    ...
    <div style="margin-top: 10px;">
      ...
      <div style="display: flex;justify-content: space-between">
        <el-button type="danger" size="small" style="justify-content: flex-start" disabled>批量删除</el-button>
          ...
          <el-row>
            <el-col :span="6">
              <el-form-item label="姓名：" prop="name">
                <el-input prefix-icon="el-icon-edit" style="width: 150px" size="mini" v-model="emp.name"
          ...
          <el-row>
            ...
            <el-col :span="5">
              <el-form-item label="籍贯：" prop="nativePlace">
                <el-input prefix-icon="el-icon-edit" style="width: 120px" size="mini" v-model="emp.nativePlace"
                          placeholder="请输入籍贯"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="电子邮箱：" prop="email">
                <el-input prefix-icon="el-icon-message" style="width: 150px" size="mini" v-model="emp.email"
                          placeholder="请输入电子邮箱"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="7">
              <el-form-item label="联系地址：" prop="address">
                <el-input prefix-icon="el-icon-edit" style="width: 200px" size="mini" v-model="emp.address"
          ...
          <el-row>
            ...
            <el-col :span="7">
              <el-form-item label="电话号码：" prop="phone">
                <el-input prefix-icon="el-icon-phone" style="width: 200px" size="mini" v-model="emp.phone"
          ...
          <el-row>
            <el-col :span="6">
              <el-form-item label="工号：" prop="workID">
                <el-input prefix-icon="el-icon-edit" style="width: 150px" size="mini" v-model="emp.workID"
            ...
            <el-col :span="6">
              <el-form-item label="毕业院校：" prop="school">
                <el-input prefix-icon="el-icon-edit" style="width: 150px" size="mini" v-model="emp.school"
                          placeholder="毕业院校名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="7">
              <el-form-item label="专业名称：" prop="specialty">
                <el-input prefix-icon="el-icon-edit" style="width: 200px" size="mini" v-model="emp.specialty"
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="身份证号码：" prop="idCard">
                <el-input prefix-icon="el-icon-edit" style="width: 180px" size="mini" v-model="emp.idCard"
...
export default {
  ...
  methods: {
    ...
    //
    //   }else{
    //     url+='?page'+ this.page + "&size=" + this.size + "&keyword=" + this.keyword
    //   }
    //   this.getRequest(url).then(resp => {
    //     this.loading = false
    //     if (resp) {
